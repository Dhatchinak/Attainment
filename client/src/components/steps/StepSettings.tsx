    ...
    <section className="workflow-panel">
      ...
      <div className="rounded-2xl border border-blue-100 bg-blue-50/60 p-4 mt-5">
        ...
        {questionWise ? (
          ...
          <p className="text-sm text-slate-600 leading-6">
            Each CIA component is evaluated using the locked marks threshold. Components mapped to the same CO are averaged, then combined as <strong>CIA {form.internalWeight}% + ESE {form.externalWeight}%</strong>.
          </p>
        )}
      </div>
