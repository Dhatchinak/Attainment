    ...
    <section className="workflow-panel">
      ...
      {!error && data && (
        <>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-3 my-5">
            ...
            <div className="metric-box"><span>Target</span><strong>{data.targetPercent}%</strong><small>Class target for level 3</small></div>
          </div>
