        ...
        <div className="flex gap-3 items-start">
          ...
          <div className="text-sm text-slate-700">
            ...
            {actualQuestionWise ? (
              ...
              <>
                <p className="mt-1 leading-6">
                  Each legacy CIA component is converted to a level using the locked marks threshold. Components covering the same CO are averaged, then combined with the ESE outcome level.
                </p>
                <div className="mt-2 font-mono text-[12px] rounded-lg bg-white border border-blue-100 px-3 py-2 overflow-x-auto">
