...
type AdmissionBatchForm = { degree: string; admissionYear: number | string; label: string; isActive: boolean };
const emptyForm: AdmissionBatchForm = { degree: "UG", admissionYear: new Date().getFullYear(), label: "", isActive: true };

export default function AdmissionBatches() {
  const [rows, setRows] = useState([]);
  const [form, setForm] = useState<AdmissionBatchForm>(emptyForm);
